...
Previously, we demonstrated how to set up MetaboExploreR for a single method. However, the package also supports multi method analysis provided that a consistent long-term reference material (LTR) has been used across all methods 
